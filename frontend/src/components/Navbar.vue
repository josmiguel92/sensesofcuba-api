    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark" :class="{'bg-dark': toggled}" v-sticky>
        ...
        <div class="container">
            <div class="navbar-left d-none d-lg-flex">
                ...
                <a v-if="currentUser.roles === 0" role="button" href="https://infonet.sensesofcuba.com/index.php/admin" class="btn btn-sm btn-primary d-flex align-items-center m-1">Admin Panel</a>
            </div>
