<template>
    <div class="container">
        <div id="products-grid" class="d-flex align-items-start justify-content-center flex-wrap">
            <div class="item mr-1 ml-1" v-for="(item, i) in items" 
                :key="i"
                ref="items"
                @click="toggle(i)"
