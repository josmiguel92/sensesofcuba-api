 ...
 */
final class Version20200107012411 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE document_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, name VARCHAR(180) NOT NULL, description LONGTEXT DEFAULT NULL, locale VARCHAR(180) NOT NULL, INDEX IDX_36C072052C2AC5D3 (translatable_id), UNIQUE INDEX document_translation_unique_translation (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE soc_product_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, name VARCHAR(180) NOT NULL, description LONGTEXT DEFAULT NULL, locale VARCHAR(180) NOT NULL, INDEX IDX_EF8BA41E2C2AC5D3 (translatable_id), UNIQUE INDEX soc_product_translation_unique_translation (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
