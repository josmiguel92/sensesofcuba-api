 ...
 */
final class Version20200112211955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE role ADD id INT AUTO_INCREMENT NOT NULL, DROP name, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
